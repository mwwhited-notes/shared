...
[BitTorrent.org](../index.html)
===============================

*   [Home](../index.html)
*   [For Users](../introduction.html)
*   [For Developers](bep_0000.html)
*   [Developer mailing list](../mailing_list.html)
*   [Forums (archive)](http://forum.bittorrent.org)
...
7392d83f374b071ca9601728c27be2d05e199e0c

Last-Modified:

Thu Aug 31 15:47:00 2017 -0700

Author:

Bram Cohen <[bram@bittorrent.com](mailto:bram%40bittorrent.com)\>
...
24-Jun-2009 ([arvid@bittorrent.com](mailto:arvid%40bittorrent.com)), clarified the encoding of strings in torrent files. 20-Oct-2012 ([arvid@bittorrent.com](mailto:arvid%40bittorrent.com)), clarified that info-hash is the digest of en bencoding found in .torrent file. Introduced some references to new BEPs and cleaned up formatting. 11-Oct-2013 ([arvid@bittorrent.com](mailto:arvid%40bittorrent.com)), correct the accepted and de-facto sizes for request messages 04-Feb-2017 ([the8472.bep@infinite-source.de](mailto:the8472.bep%40infinite-source.de)), further info-hash clarifications, added resources for new implementors 14-May-2017 ([ssiloti@bittorrent.com](mailto:ssiloti%40bittorrent.com), [the8472.bep@infinite-source.de](mailto:the8472.bep%40infinite-source.de)), v2 wire protocol and torrent format
...
Note that in the context of bencoding strings including dictionary keys are arbitrary byte sequences (uint8\_t\[\]).
    ...
    file tree: {
      dir1: {
        dir2: {
          fileA.txt: {
            "": {
              length: _<length of file in bytes (integer)>_,
              pieces root: _<optional, merkle tree root (string)>_,
              ...
            }
          },
          fileB.txt: {
