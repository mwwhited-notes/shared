...
Welcome... this is a collection of my personal notes. Please feel free to use them but this is a live collection so if stuff gets moved around sorry... this is just how my brain works.
...
- [Notes](#notes)
  - [Computing & Development](#computing--development)
...
Curated collection of analog computing resources (~232 PDFs, 660MB).

- **[AnalogComputers/](AnalogComputers/)** - Main collection
- **[Research Protocol](AnalogComputers/analog-computing-repository/research-protocol.md)** - Search strategies by topic
- **[Download Sources](AnalogComputers/analog-computing-repository/download-sources.md)** - PDF source registry

Topics covered:
- Fundamentals and op-amp basics
- Aerospace simulation (Apollo, fire control, hybrid computing)
- Vintage computer manuals (EAI, Heathkit, Comdyna)
- Application notes (ADI, TI, ALPACA, biomedical)
...
Utility scripts for various platforms and tools.

| Category | Location | Description |
|----------|----------|-------------|
| Containers | [Scripts/containers/](Scripts/containers/) | Docker/container scripts |
...
| Profile | [Scripts/profile/](Scripts/profile/) | Shell profiles |
