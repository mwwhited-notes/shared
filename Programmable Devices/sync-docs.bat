...
REM ============================================================================
REM sync-docs.bat
REM Syncs Programmable Devices documentation to OneDrive
REM ============================================================================
...
REM Configuration
set "SOURCE=%~dp0"
set "DEST=%USERPROFILE%\OneDrive\Documents\ProgrammableDevices"

REM Remove trailing backslash from source if present
if "%SOURCE:~-1%"=="\" set "SOURCE=%SOURCE:~0,-1%"

echo ============================================================================
echo  Programmable Devices Documentation Sync
echo ============================================================================
echo.
echo  Source: %SOURCE%
