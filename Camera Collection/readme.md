...
M42 screw-mount lenses can be adapted to:
- **Nikon F-mount** - With M42-Nikon adapter (infinity focus maintained with correction element)
- **Canon EF** - With simple adapter
- **Sony E** - With simple adapter
- **Fuji X** - With simple adapter
- **Micro Four Thirds** - With simple adapter

### Nikon F-Mount

Native F-mount lenses work on:
- Nikon D800 (FX, full metering/AF with AF-S lenses)
- Nikon FG-20 (AI metering, manual focus)

### Nikon Z-Mount

Native Z-mount lenses work on all Nikon Z mirrorless cameras.

Adapted lenses via Fotasy adapters:
- **M42 to Z** - All M42 screw mount lenses (Helios, Industar, Spiratone, etc.)
- **Canon FD to Z** - Canon FD/FL mount lenses
...
| Item | Type | Price |
|------|------|-------|
| Sky-Watcher Star Adventurer 2i Pro Pack | Star Tracker | $425.00 |
| Astromania Bahtinov Mask (FM60mm) | Focusing Aid | $12.99 |
| USB Lens Dew Heater Strip | Dew Prevention | $14.98 |
| TKDY EN-EL15 Dummy Battery + AC Adapter | Power Supply | $33.99 |
| 77-82mm Step Up Rings (2 pack) | Filter Adapter | $8.59 |
| ICE 82mm LiPo Light Pollution Filter | Filter | $44.95 |
| Neewer Intervalometer (Nikon) | Remote/Timer | $16.99 |
| Selens Tripod Weight Bag | Stabilizer | $12.95 |

*Astrophotography accessories total: $570.44*
...
- Sigma 300mm f/2.8 needs focus ring repair (purchased from problematic seller)
- M42 lenses purchased for use on Mamiya body and adapted to Nikon Z
- FG-20 was a bonus with D800 purchase (great film body for AI lenses)
- Astrophotography setup uses Star Adventurer tracker with D800
